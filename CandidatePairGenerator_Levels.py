from ddlite import *
import unicodedata
import BiomarkerCandidateGenerator, LevelCandidateGenerator, MeasurementTypeCandidateGenerator, TestSetCandidateGenerator, pickle
...
def doEverything():
    ...
    keyWords_Measurement_Type = ["median", "mean", "standard deviation", "range", "level", "value", "concentration", "normal", "mode", "variance", "p="]
    keyWords_Test_Set = ["cohort", "normal", "subject", "patient", "group", "control", "sample", "candidate", "case", "people", "individual", "human"]
    ...
    def LF_n_equals_notation(m):
        post_text = m.post_window4(attribute='text')
        normalized_post_text = unicodedata.normalize('NFKD', sentence).encode('ascii', 'ignore')
